  ...
  return (
    <main className="min-h-screen pt-32 pb-20">
      <div className="container max-w-3xl mx-auto px-4">
        ...
        <h1 className="h2 mb-2 text-stone-900">Política de Privacidade</h1>
        ...
        <div className="prose max-w-none text-stone-600 leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">1. Dados que recolhemos</h2>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">2. Como usamos os teus dados</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">3. Com quem partilhamos</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">4. Os teus direitos</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">5. Contacto</h2>
          <p>
