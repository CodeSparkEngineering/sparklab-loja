  ...
  return (
    <main className="min-h-screen pt-32 pb-20">
      <div className="container max-w-3xl mx-auto px-4">
        ...
        <h1 className="h2 mb-2 text-stone-900">Termos e Condições</h1>
        <p className="text-sm text-stone-600 mb-10">Última atualização: junho de 2026</p>
        ...
        <div className="prose max-w-none text-stone-600 leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">1. Encomendas e pagamento</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">2. Envio</h2>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">3. Peças personalizadas</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">4. Ficheiros STL</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">5. Defeitos e trocas</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-stone-900 mt-8">6. Propriedade intelectual</h2>
          <p>
