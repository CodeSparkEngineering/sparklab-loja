...
export const PRODUCTS: Product[] = [
  ...
  { id: 'caneca-brasil', name: 'Caneca Seleção Brasil', desc: 'Caneca com a temática da Seleção do Brasil. Perfeita para os fãs da Canarinha.', price: 20, tag: 'Canecas', tone: 'yellow', icon: '☕', images: ['/images/caneca-brasil-1.jpg', '/images/caneca-brasil-2.jpg', '/images/caneca-brasil-3.jpg'] },
  { id: 'caneca-palmeiras', name: 'Caneca Palmeiras', desc: 'Caneca "Verdão" para os adeptos do Palmeiras, com o escudo e as cores alviverdes. Personalizável com o teu nome.', price: 20, tag: 'Canecas', tone: 'green', icon: '☕', images: ['/images/caneca-palmeiras-1.jpg'], customizations: [ { id: 'nome', label: 'Nome a gravar (ex: ISRAEL)', type: 'text', maxLength: 12 } ] },
  { id: 'caneca-vasco', name: 'Caneca Vasco', desc: 'Caneca "Gigante da Colina" para os Vascaínos, com o escudo clássico em preto e branco. Personalizável com o teu nome.', price: 20, tag: 'Canecas', tone: 'slate', icon: '☕', images: ['/images/caneca-vasco-1.jpg'], customizations: [ { id: 'nome', label: 'Nome a gravar (ex: ISRAEL)', type: 'text', maxLength: 12 } ] },
  { id: 'caneca-corinthians', name: 'Caneca Corinthians', desc: 'Caneca "Timão" para a Fiel, com o escudo do Corinthians em preto, branco e vermelho. Personalizável com o teu nome.', price: 20, tag: 'Canecas', tone: 'slate', icon: '☕', images: ['/images/caneca-corinthians-1.jpg'], customizations: [ { id: 'nome', label: 'Nome a gravar (ex: ISRAEL)', type: 'text', maxLength: 12 } ] },
];
