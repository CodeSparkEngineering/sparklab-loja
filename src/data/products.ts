...
export const PRODUCTS: Product[] = [
  ...
  { id: 'chaveiro-mini-caneca', name: 'Porta-Chaves Mini Caneca', nameEn: 'Mini Mug Keychain', desc: 'Mini-caneca de café em porta-chaves, super fofa, com o teu topo à escolha — marshmallows, coração, coelho, chantilly ou latte art. O detalhe perfeito para mochilas e chaves.', descEn: 'A super cute mini coffee-mug keychain with your topping of choice — marshmallows, heart, bunny, whipped cream or latte art. The perfect detail for backpacks and keys.', price: 4, tag: 'Porta-Chaves', tone: 'purple', icon: '☕', images: ['/images/porta-chaves-mini-caneca-1.jpg', '/images/porta-chaves-mini-caneca-2.jpg', '/images/porta-chaves-mini-caneca-3.jpg', '/images/porta-chaves-mini-caneca-4.jpg'], customizations: [ { id: 'topo', label: 'Topo à escolha (ex: marshmallows, coração, coelho, chantilly, latte art)', labelEn: 'Topping of choice (e.g. marshmallows, heart, bunny, whipped cream, latte art)', type: 'text', maxLength: 40 } ] },
