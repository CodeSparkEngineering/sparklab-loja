...
const L = {
  pt: {
    ...
    wholesale: '🏷️ Desconto de Atacado (10+ un.)',
    ...
    wholesaleLine: <><strong>Descontos exclusivos</strong> para compras no atacado (a partir de 10 unidades). Entre em contato!</>,
  ...
  en: {
    ...
    wholesale: '🏷️ Wholesale discount (10+ units)',
    ...
    wholesaleLine: <><strong>Exclusive discounts</strong> for wholesale orders (from 10 units). Get in touch!</>,
