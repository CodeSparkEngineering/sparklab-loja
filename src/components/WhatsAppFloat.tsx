...
/**
 * Botão flutuante de WhatsApp, sempre visível (canto inferior DIREITO). Com
 * 86% do tráfego em telemóvel, é dos contactos de maior conversão. z-95: por
 * baixo do header (100) e do carrinho (200). O "voltar ao topo" empilha-se
 * ACIMA deste botão (ver o bottom elevado em BackToTop).
 */
const L = {
